...
outputFile = open('alphavspeak.txt','w')
...
for k in range (len(alpha)):
	...
	Calpha = alpha[k] * float(deltaPx * deltaPy) / 2.0 / math.pi	#takes care of
																	#integral approximation
	ixvals = np.array(range(Nx))				#[0,1,2,...,Nx-1]
